...
if response.function_calls:
    ...
    # --------------------------------------------------
    # 6. Execute every requested tool call
    # --------------------------------------------------
    ...
    # --------------------------------------------------
    # 7. Send all weather results back to Gemini
    # --------------------------------------------------
    ...
    You are now the final decision-maker for this travel request.

    Analyze the weather information you collected for all requested cities.
    ...
    4. ONE clear best city for the weekend trip
    5. A short explanation for your choice
    6. Clothing recommendation
    7. Umbrella recommendation

    Do not give only conditional recommendations.
    You must select ONE best city based primarily on the current weather data.

    Give the final answer in a clear, beginner-friendly format.
    """
    ...
    contents.append(
        ...
        role="user",
        parts=[
            types.Part(text=decision_instruction)
            ]
            )
    )
